...
#back button
 ...
 def add_data(self):
     ...
     elif not any(ch.isdigit() for ch in id):
         msg = 'Enter valid id'
         messagebox.showerror(
     ...
     elif not any(ch.isdigit() for ch in phone)  or len(phone)!=10:
